...
/**
 * The basic body class. Known sub classes are:
 * {@link Sphere}.
 * @author CJG
 *
 */
public abstract class Body {
	 ...
	 * @param origin the body origin in world space.
	 * @param quat the body rotation in world space.
	 * @param bounds the bounding sphere of the body in world space.
	 */
